...
function qe(e) {
	...
	else if (e instanceof T) return T.create(qe(e.unwrap()));
...
var w = class e extends C {
	...
	required(t) {
		...
		for (let e of l.objectKeys(this.shape)) if (t && !t[e]) n[e] = this.shape[e];
			...
			let t = this.shape[e];
			for (; t instanceof T;) t = t._def.innerType;
			n[e] = t;
		}
		return new e({
			...this._def,
...
var Ye = (e) => e instanceof it ? Ye(e.schema) : e instanceof ut ? Ye(e.innerType()) : e instanceof at ? [e.value] : e instanceof st ? e.options : e instanceof ct ? l.objectValues(e.enum) : e instanceof ft ? Ye(e._def.innerType) : e instanceof Be ? [void 0] : e instanceof Ve ? [null] : e instanceof T ? [void 0, ...Ye(e.unwrap())] : e instanceof dt ? [null, ...Ye(e.unwrap())] : e instanceof ht || e instanceof _t ? Ye(e.unwrap()) : e instanceof pt ? Ye(e._def.innerType) : [], Xe = class e extends C {
	_parse(e) {
...
lt.create, ut.create, T.create, dt.create, ut.createWithPreprocess, gt.create;
//#endregion
...
}, Bs = document.getElementById("messages"), Vs = document.getElementById("input"), Hs = document.getElementById("send"), Us = [];
function Ws(e, t) {
...
async function Gs() {
	...
	new zs({ url: "/agui" }).run({
		...
		next: (e) => {
			e.type === P.TEXT_MESSAGE_CONTENT && (r += e.delta ?? "", n.textContent = r, Bs.scrollTop = Bs.scrollHeight);
		},
		error: (e) => {
			n.textContent = `Error: ${e}`, Hs.disabled = !1;
		},
		complete: () => {
			r && Us.push({
				id: crypto.randomUUID(),
...
Hs.addEventListener("click", Gs), Vs.addEventListener("keydown", (e) => {
	e.key === "Enter" && !e.shiftKey && Gs();
}), Vs.focus();
//#endregion
