...
namespace Plugin.McpBridge
{
	...
	internal sealed class PluginSettingsHelper
	{
		...
		public String ReadPluginSetting(String pluginId, String settingName)
		{
			...
			String errorMessage;
			if(!this.TryGetPluginSettingsInstance(pluginId, out pluginDescription, out settingsInstance, out errorMessage))
				return errorMessage;
		...
		public String UpdatePluginSetting(String pluginId, String settingName, String settingValue)
		{
			...
			if(!this.TryConvertSettingValue(settingValue, propertyInfo.PropertyType, out convertedValue, out errorMessage))
				return errorMessage;
